...
extern torch::Tensor sta_forward(torch::Tensor q, torch::Tensor k, torch::Tensor v, torch::Tensor o, torch::Tensor img_size, torch::Tensor tile_size, torch::Tensor kernel_size, int text_length, bool process_text);
#endif
...
#ifdef TK_COMPILE_ATTN
    m.def("sta_fwd", torch::wrap_pybind_function(sta_forward), "sliding tile attention with templatized tile sizes");
